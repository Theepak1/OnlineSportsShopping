 package com.capg.onlinesportsshopee.bean;
  ...
  @Table(name="cart") public class Cart implements Serializable{
  ...
  @Column(name="cartid" ) private long cartId;
  
  @Column(name="imagename") private String imageName;
  
  @Column(name="productname", nullable=false, length=20)
  
  @NotBlank(message="ProductName should not be blank") private String
  productName;
  
  @Column(name="quantity", nullable=false)
  
  @NotBlank(message="Quantity should be specified") private int quantity;
  ...
  public Cart(long cartId, String imageName, String productName, int quantity,
  ...
  ", imageName=" + imageName + ", productName=" + productName + ", quantity=" +
